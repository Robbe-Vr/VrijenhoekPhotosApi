...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AlbumDTOTagDTO", b =>
                {
                    b.Property<int>("AlbumsId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GroupDTOUserDTO1", b =>
                {
                    b.Property<int>("PendingJoinGroupsId")
                        .HasColumnType("int");

                    b.Property<string>("PendingJoinUsersId")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("PendingJoinGroupsId", "PendingJoinUsersId");
            ...
            modelBuilder.Entity("GroupDTOUserDTO2", b =>
                {
                    b.Property<int>("RequestedJoinGroupsId")
                        .HasColumnType("int");

                    b.Property<string>("RequestedJoinUsersId")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("RequestedJoinGroupsId", "RequestedJoinUsersId");
            ...
            modelBuilder.Entity("AlbumDTOTagDTO", b =>
                {
                    ...
                    b.HasOne("VrijenhoekPhotos.Exchange.Classes.TagDTO", null)
                        .WithMany()
            ...
            modelBuilder.Entity("GroupDTOUserDTO1", b =>
                {
                    b.HasOne("VrijenhoekPhotos.Exchange.Classes.GroupDTO", null)
                        .WithMany()
                        .HasForeignKey("PendingJoinGroupsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("GroupDTOUserDTO2", b =>
                {
                    b.HasOne("VrijenhoekPhotos.Exchange.Classes.GroupDTO", null)
                        .WithMany()
                        .HasForeignKey("RequestedJoinGroupsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
